class Form {
  ...
  display() {
    ...
    this.character.style('borderRadius', '20px')
    this.character.style('borderWidth', '7px')
    ...
    this.play.style('borderRadius', '20px')
    this.play.style('borderWidth', '7px')
    this.play.style('background', 'yellow')
    this.play.style('font-family', 'Arial Black	')
    ...
    this.settings.style('borderRadius', '20px')
    this.settings.style('borderWidth', '7px')
    ...
    this.instruction.style('borderRadius', '20px')
    this.instruction.style('borderWidth', '7px')
